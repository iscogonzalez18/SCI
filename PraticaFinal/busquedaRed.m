...
for i = 1:numSimulaciones
    ...
    loaded_data = load(filename);  % asume que dentro contiene 'training_data'
    
    % Suponiendo que cada 'training_data' sea una matriz con 
...
results = table('Size',[0 4], ...
                ...
                'VariableNames', {'PerformanceVal','Net','Architecture','PerformanceTrain'});
...
for n1 = rangoCapa1
    for n2 = rangoCapa2
        ...
        % ENTRENAMIENTO (opciones por defecto, normalmente trainlm en problemas de regresión)
